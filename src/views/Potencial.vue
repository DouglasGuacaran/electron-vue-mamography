          ...
          <div class="col-6 table" >
              <table v-for ="(item, index) in items1" :key="'B'+index"> 
                  ...
                  <tr v-for="(item, index) in items" :key="'A'+index">
                    <td> <input class="inputs" v-model="item.kv" @change="edit($event, index)"/></td>
                    <td> <input class="inputs" v-model="item.kvMedido" @change="edit($event, index)"/></td>
                    <td>{{item.dif}}</td>
